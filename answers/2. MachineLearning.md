...
![Untitled](Machine%20Learning%20(02%2011)%206270568a90aa4785bd059d76a47eae43/Untitled.png)
...
![Untitled](Machine%20Learning%20(02%2011)%206270568a90aa4785bd059d76a47eae43/Untitled%201.png)
...
$$
y_i=β_0+β_1⋅x_i+ε_i\\\ \hat{y_i}=β+α⋅x_i⋅
$$

우리는 위와 같은 식을 가정할 수 있고, 데이터로부터 x값이 주어졌을때 **예측값 $\hat{y_i}$**를 얻을 수 있다. 하지만 하나의 선으로 모든 y값을 정확히 나타낼 수 없기 때문에 우리가 예측한 $\hat{y_i}$와 **실제 데이터 $y_i$**에는 차이가 존재한다. 이러한 **차이를 오차(Error)**라고 하며 **ϵ**으로 표기한다.
...
**오차의 제곱(= ε$^2$)**을 최소화 하는 β와 α를 추정하는 방식이다.

- SSE란, Sum of Squared Error의 약자로 오차의 제곱값을 합한 것이다.

![Untitled](Machine%20Learning%20(02%2011)%206270568a90aa4785bd059d76a47eae43/Untitled%202.png)

SSE를 최소화하는 α와 β를 찾아야 하므로, SSE를 각각 α와 β에 대해 미분한다. 

![Untitled](Machine%20Learning%20(02%2011)%206270568a90aa4785bd059d76a47eae43/Untitled%203.png)

(1)번식에다가 $\bar{x}$를 곱하면 (3)

(3)번식에서 $\Sigma{y}=n*\bar{y}$를 이용해서 (4)번 식을 만든다

![Untitled](Machine%20Learning%20(02%2011)%206270568a90aa4785bd059d76a47eae43/Untitled%204.png)

이제 (4) - (3)하면,

![Untitled](Machine%20Learning%20(02%2011)%206270568a90aa4785bd059d76a47eae43/Untitled%205.png)

이렇게 x의 계수 α의 예측값 $\hat{α}$은 위와 같이 구할 수 있고,

$\hat{β}$는 (1)번식을 이용하여 아래와 같이 구할 수 있다. (다차원이므로, n으로 나눠주는 것..?)

![Untitled](Machine%20Learning%20(02%2011)%206270568a90aa4785bd059d76a47eae43/Untitled%206.png)
...
![Untitled](Machine%20Learning%20(02%2011)%206270568a90aa4785bd059d76a47eae43/Untitled%207.png)
